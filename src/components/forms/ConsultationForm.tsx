  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
      ...
      <StaggerGroup className="grid gap-5 md:grid-cols-2">
        ...
        <StaggerItem><Field label="Event type" error={error("eventType")}><select className={fieldClass} {...register("eventType")}><option value="">Select</option><option>Wedding</option><option>Pre-wedding</option><option>Engagement</option><option>Haldi / Mehendi / Sangeet</option><option>Reception</option><option>Maternity shoot</option><option>Baby shoot</option><option>Birthday</option><option>Corporate event</option><option>Private celebration</option></select></Field></StaggerItem>
